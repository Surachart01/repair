<?php 
    ...
    $id = $_POST['id'];
    $sqlGetProblem = "SELECT * FROM problems WHERE id = '$id'";
...
<div class="d-flex">
                            <div class="me-3">
                                ...
                                <div class="input-group mb-3 ">
                                    ...
                                    <input type="text" class="form-control" id="accessory" placeholder="ประเภทของวัสดุ" aria-label="Username" aria-describedby="basic-addon1" value="<?php echo $dataProblem->itemName ?>">
                                </div>
                            </div>
                            <div class="">
                                ...
                                <div class="input-group mb-3 ">
                                    ...
                                    <input type="text" class="form-control" id="code" placeholder="0000-0000" aria-label="Username" aria-describedby="basic-addon1" value="<?php echo $dataProblem->itemCode ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <button class="btn btn-success my-3" id="btnEdit" data-id="<?php echo $id ?>">บันทึก</button>